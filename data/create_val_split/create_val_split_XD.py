...
name = "/home/cv05f23/data/XD/files/rgb_train.list"
# name = "/home/marc/Documents/data/xd/files/rgb_train.list"
with open(name, 'w+') as f:  ## the name of feature list
    for file in train:
        newline = path+'/'+file+'\n'
        f.write(newline)

name = "/home/cv05f23/data/XD/files/rgb_val.list"
# name = "/home/marc/Documents/data/xd/files/rgb_val.list"
with open(name, 'w+') as f:  ## the name of feature list
    for file in val:
        newline = path+'/'+file+'\n'
        f.write(newline)
