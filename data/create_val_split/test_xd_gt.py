...
gt_file_path = rf"/home/marc/Documents/GitHub/8semester/Weakly-supervised-anomaly-detection/files/XD_list/xd.list"
...
print("Amount of anomaly frames to all frames:", np.sum(res)/len(res))
