...
# pred = np.load(f"/home/marc/Documents/data/UCF/results/rftm/nept_id_RTFMUC-22/rftm91-i3d_test.npy")
pred = np.load(f"/home/marc/Documents/data/UCF/results/rftm/nept_id_RTFMUC-38/rftm771-i3d_test.npy")
...
for i in val:
    ...
    path = f"/home/marc/Documents/data/UCF/results/RTFM/Plots_their2/" + string[:-3] + ".jpg"
    ...
    if nept:
        run[f"plots/RTFM/{string[:-3]}"].upload(path)
...
plt.legend()
path = f"/home/marc/Documents/data/UCF/results/RTFM/Plots_their2/" + "roc" + ".jpg"
plt.savefig(path, bbox_inches='tight')
plt.close()
...
path = f"/home/marc/Documents/data/UCF/results/RTFM/Plots_their2/" + "pr" + ".jpg"
plt.savefig(path, bbox_inches='tight')
plt.close()
